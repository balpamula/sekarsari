                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card shadow mb-2">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form method="POST" action="<?= site_url('Menu/edit'); ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-6 col-md-3">
                                                ...
                                                <textarea class="form-control" rows="8" name="deskripsi"><?= $menu->deskripsi; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-6 col-md-3">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-6 col-md-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="file" name="gambar" class="form-control" value="<?= $menu->harga; ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                </div>
